...
<head>
    ...
    <title>BulletinBoard List of ad by category</title>
</head>
<body>
...
<main role="main" class="container">
    <h1 class="mt-5">Объявления выбранной категории</h1>
    <div class="list-group flex-row flex-wrap d-flex p-2 bd-highlight justify-content-sm-between"
         id="list-of-ad-by-category-id">
    </div>
...
<script>
    ...
    var url = "${contextPath}/list-of-ad/list-of-ad-by-category-id-ajax";
    var contextPath = "${contextPath}";
    var categoryId = "${categoryId}";
</script>
<script src="${resPath}/js/get-data-for-content-list-of-ad-by-category-id.js"></script>
