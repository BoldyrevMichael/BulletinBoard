...
<script>
    ...
    var url = "${contextPath}/list-of-ad/list-of-ad-by-company-id-ajax";
    var contextPath = "${contextPath}";
    var companyId = "${companyId}";
</script>
<script src="${resPath}/js/get-data-for-content-list-of-ad-by-company-id.js"></script>
